...
namespace E_DictionaryBook.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //works off of user name, you should double check that the user name is the same as the email you are passing in.
            //so email should by the same like username, other the SignInManager.PasswordSignInAsync method
            //can't login correctly. This method use UserName, not eMail.'
            //If username != email 
